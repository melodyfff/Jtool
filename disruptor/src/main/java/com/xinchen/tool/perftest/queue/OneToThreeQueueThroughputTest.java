...
import com.xinchen.tool.perftest.support.ValueQueueProcessorMutationr;
 ...
 * @author xinchen
 * @version 1.0
 * @date 01/07/2020 11:38
 */
public class OneToThreeQueueThroughputTest extends AbstractPerfTestQueue {
    ...
    private final ValueQueueProcessorMutationr[] queueProcessors = new ValueQueueProcessorMutationr[NUM_EVENT_PROCESSORS];

    {
        queueProcessors[0] = new ValueQueueProcessorMutationr(blockingQueues[0], Operation.ADDITION, ITERATIONS - 1);
        queueProcessors[1] = new ValueQueueProcessorMutationr(blockingQueues[1], Operation.SUBTRACTION, ITERATIONS - 1);
        queueProcessors[2] = new ValueQueueProcessorMutationr(blockingQueues[2], Operation.AND, ITERATIONS - 1);
    }
