...
import com.xinchen.tool.perftest.support.FunctionQueueProcessor;
 ...
 * @author xinchen
 * @version 1.0
 * @date 01/07/2020 13:38
 */
public class OneToThreePipelineQueueThroughputTest extends AbstractPerfTestQueue {
    ...
    private final FunctionQueueProcessor stepOneQueueProcessor = new FunctionQueueProcessor(FunctionStep.ONE, stepOneQueue, stepTwoQueue, stepThreeQueue, ITERATIONS - 1);
    private final FunctionQueueProcessor stepTwoQueueProcessor = new FunctionQueueProcessor(FunctionStep.TWO, stepOneQueue, stepTwoQueue, stepThreeQueue, ITERATIONS - 1);
    private final FunctionQueueProcessor stepThreeQueueProcessor = new FunctionQueueProcessor(FunctionStep.THREE, stepOneQueue, stepTwoQueue, stepThreeQueue, ITERATIONS - 1);
    ...
    protected long runQueuePass() throws Exception {
        ...
        failIfNot(expectedResult, stepThreeQueueProcessor.getStepThreeCounter());
